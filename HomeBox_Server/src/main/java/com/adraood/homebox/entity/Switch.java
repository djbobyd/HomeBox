...
@NamedQueries({
    ...
    @NamedQuery(name = "Switch.findByName", query = "SELECT s FROM Switch s WHERE s.name = :name")})
public class Switch implements Entity {
    ...
    public String toString() {
        return "net.dontdrinkandroot.example.angularrestspringsecurity.entity.Switch[ id=" + id + " ]";
    }
